...
export default function Home() {
  return (
    <main className="relative min-h-screen flex flex-col bg-black selection:bg-doom-green selection:text-black">
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-between px-3 sm:px-4 py-6 sm:py-8 md:py-12">
        {/* Main Content */}
        <div className="flex flex-col items-center w-full max-w-6xl grow justify-center">
          <motion.div
            ...
            className="mb-4 sm:mb-6 relative w-full h-auto max-w-3xl flex justify-center px-2"
          >
        ...
        <div className="flex flex-col items-center gap-2 text-gray-500 text-[10px] sm:text-[10px] tracking-widest font-montserrat mt-auto pt-6 sm:pt-8 px-4">
          <span className="uppercase text-center">December 18, 2026</span>
          <div className="flex flex-wrap items-center justify-center gap-2 text-gray-400">
            ...
            <a
              ...
              className="lowercase text-xs sm:text-sm tracking-normal underline decoration-1 underline-offset-4 font-sans hover:text-white transition-colors"
            >
            ...
            >
              <div className="relative flex items-center justify-center w-4 h-4 sm:w-5 sm:h-5">
                ...
                {/* X Icon */}
                <svg
                  className="w-3 h-3 sm:w-3.5 sm:h-3.5 fill-current group-hover:scale-110 transition-transform duration-300"
                  viewBox="0 0 24 24"
                >
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </div>
              <span className="text-[10px] sm:text-xs tracking-wide font-sans group-hover:underline underline-offset-4 decoration-doom-green/50">
                @sentrytoast
              </span>
            </a>
          </div>
